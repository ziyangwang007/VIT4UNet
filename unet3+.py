...
name = 'unet3plus'
activation = 'ReLU'
# filter_num_down = [32, 32, 32, 32, 32]
...
unet3plus = models.unet_3plus_2d(input_size=(128, 128, 3), n_labels=3, filter_num_down = [32, 64, 128, 256, 512],
                    stack_num_down=2, stack_num_up=1, output_activation='Sigmoid',  deep_supervision=False,  name='unet3plus')
unet3plus.summary()
...
unet3plus.load_weights(os.path.join(weight_dir, '2dunet3+callback.h5'))
...
np.save('pred_unet3plus.npy', y_pred)
