...
r2_unet = models.r2_unet_2d((128, 128, 3), [64, 128, 256, 512], n_labels=3,
...
model_checkpoint = keras.callbacks.ModelCheckpoint(filepath=os.path.join(weight_dir, '2dr2_unetcallback.h5'),monitor='val_loss', save_best_only=True)


r2_unet.compile(loss=[hybrid_loss, hybrid_loss, hybrid_loss, hybrid_loss, hybrid_loss],
...
r2_unet.load_weights(os.path.join(weight_dir, '2dr2_unetcallback.h5'))
temp_out = r2_unet.predict([test_input,])
# y_pred = temp_out[-1]
y_pred = temp_out
