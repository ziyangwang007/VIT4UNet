...
u2net = models.u2net_2d((128, 128, 3), n_labels=3, 
...
model_checkpoint = keras.callbacks.ModelCheckpoint(filepath=os.path.join(weight_dir, '2du2netcallback.h5'),monitor='val_loss', save_best_only=True)


u2net.compile(loss=[hybrid_loss, hybrid_loss, hybrid_loss, hybrid_loss, hybrid_loss],
...
u2net.load_weights(os.path.join(weight_dir, '2du2netcallback.h5'))
temp_out = u2net.predict([test_input,])
# y_pred = temp_out[-1]
# y_pred = temp_out
